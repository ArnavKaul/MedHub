    ...
    <div className="container">
      ...
      {items.length === 0 ? (
        ...
        <>
            ...
            {items.map((item) => (
              <li key={item.id} className="cart-item">
                ...
                <div className="cart-item-details">
                  ...
                  <button  id="btn-cart" onClick={() => updateItemQuantity(item.id, item.quantity + 1)}>+</button>
                
                  <button  id="btn-cart" onClick={() => updateItemQuantity(item.id, item.quantity - 1)}>-</button>
                  <button  id="btn-cart" onClick={() => removeItem(item.id)}>Remove</button>
                  <hr></hr>
                </div>
              </li>
            ))}
          ...
          <button id="btn-cart" onClick={emptyCart}>Clear Cart</button>
        </>
      )}
      <Footer></Footer>
    </div>
