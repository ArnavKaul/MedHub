...
const Multivitamins = () => {
  ...
  return (
    <div className="container">
      ...
      <img className="multivitamins-img" src={'./images/Multivitamins.jpeg'} alt="Multivitamins" />
      
      <p className="multivitamins-p">
        Multivitamins are dietary supplements designed to provide essential vitamins and minerals that may be lacking in a person's daily diet.
      </p>

      <button className="add-to-cart" id="btn-multivitamins">Add to Cart</button>
          ...
          <>
            ...
            {reviews.map((review, index) => (
              <div key={index} style={{ padding: "10px", border: "1px solid #ddd", borderRadius: "5px", marginBottom: "10px" }}>
                <StarRating name={`review-${index}`} starCount={5} value={review.rating} editing={false} />
